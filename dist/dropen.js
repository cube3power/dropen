...
function _emitter() {
  ...
  ['addEventListener', 'dispatchEvent', 'removeEventListener'].forEach(d, this);
}
...
function FileDnD(el, configure) {
  ...
  if (_configure.preview) {
    this._preview = (0, _utils.makeElement)(_configure.preview);
  }
  ...
  this._autoPreview = typeof _configure.autoPreview === 'undefined' ? true : _configure.autoPreview;

  this._autoRefresh = typeof _configure.autoRefresh === 'undefined' ? true : _configure.autoRefresh;
